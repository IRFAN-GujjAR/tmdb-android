        ...
        NavDisplay(
            ...
            entryProvider = entryProvider {
                HomeScreenEntries(
                    ...
                    onNavigateToTMDBMediaList = { addToBackStack(it) },
                    onNavigateToMovieCredits = { addToBackStack(it) },
                    onNavigateToTvShowCredits = { addToBackStack(it) },
                    onNavigateToRateMedia = { addToBackStack(it) }
                )
            }
        )
    }
