...
class AccountDetailsRepositoryImpl(
    ...
    override suspend fun getAccountDetails(sessionId: String): AccountDetailsEntity {
    ...
    override suspend fun watchAccountDetails(): Flow<AccountDetailsEntity?> =
        localDataSource.watchAccountDetails()
